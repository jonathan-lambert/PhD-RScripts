...
make_two_column_power_table <- function(power.summary.pooled,
  ...
  cat("\\centering\n")
  cat("\\scriptsize\n")
  cat(sprintf("\\caption{Power Use Distributions (%s): Descriptive statistics summarising power use observations across workload categories and Garbage Collector variants under %s.}\n",
  ...
  cat("\\textbf{Category} & \\textbf{GC} & \\textbf{M} & \\textbf{M$_d$} & \\textbf{SD} & \\textbf{IQR}\n")
  cat("&\n")
  cat("\\textbf{Category} & \\textbf{GC} & \\textbf{M} & \\textbf{M$_d$} & \\textbf{SD} & \\textbf{IQR} \\\\\n")
...
make_two_column_energy_table <- function(df,
  ...
  cat("\\centering\n")
  cat("\\scriptsize\n")
  cat(sprintf("\\caption{Energy Consumption Distributions (%s): Descriptive statistics summarising energy consumption observations across workload categories and Garbage Collector variants under %s.}\n",
              heading, tolower(heading)))
  cat("\\begin{tabular}{llrrrr@{\\hspace{6mm}}llrrrr}\n")
  cat("\\toprule\n")
...
make_two_column_energy_table.tiered <- function(df,
  ...
  cat("\\centering\n")
  cat("\\scriptsize\n")
  cat(sprintf("\\caption{Energy Consumption Distributions (%s): Descriptive statistics summarising energy consumption observations across workload categories and Garbage Collector variant under %s.}\n",
              heading, tolower(heading)))
  cat("\\begin{tabular}{llrrrr@{\\hspace{6mm}}llrrrr}\n")
  cat("\\toprule\n")
