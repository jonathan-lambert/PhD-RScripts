...
energy_model <- lm(energy_formula, data = data.hs)
...
knitr::kable(
  ...
  digits = 3,
  row.names = FALSE,
  caption = "Stratified bootstrap coefficient stability analysis for the tiered execution energy consumption regression model.",
