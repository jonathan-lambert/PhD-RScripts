...
power_model <- lm(power_formula, data = data.int)
...
knitr::kable(
  ...
  digits = 3,
  row.names = FALSE,
  caption = "Stratified bootstrap coefficient stability analysis for the interpretive execution power use regression model.",
